...
ax.fill_between(forecast["ds"], forecast["yhat_lower"], forecast["yhat_upper"],
                 color = 'salmon', alpha = 0.3, label = "Prediction Interval")
...
merged = pd.merge(df, forecast, left_on = 'ds', right_on = 'ds', how = 'inner')
...
ax2.plot(merged["ds"], merged["residual"],
         color = 'purple', marker = 'o', label = "Residual")
ax2.axhline(0, 0, 1, color = 'black', linestyle='--')  # 기준선
